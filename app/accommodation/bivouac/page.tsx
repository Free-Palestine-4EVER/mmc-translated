    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-black text-white">
        ...
        <div className="container relative z-10 flex flex-col items-center justify-center py-24 md:py-32 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight md:text-6xl lg:text-7xl">{t("bivouac.title")}</h1>
      ...
      <section className="bg-gradient-to-b from-amber-500 to-amber-600 py-16 text-white">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 text-3xl font-bold">{t("bivouac.magicNightTitle")}</h2>
            <p className="mb-8 text-lg">
              {t("bivouac.magicNightDesc1")}
            </p>
            <p className="text-lg">
              {t("bivouac.magicNightDesc2")}
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="mb-8 text-center text-3xl font-bold">{t("bivouac.howItWorksTitle")}</h2>
          <div className="mx-auto max-w-3xl">
            <p className="mb-6 text-gray-700">
              {t("bivouac.howItWorksDesc1")}
            </p>
            <p className="mb-6 text-gray-700">
              {t("bivouac.howItWorksDesc2")}
            </p>
            <p className="mb-6 text-gray-700">
              {t("bivouac.howItWorksDesc3")}
            </p>
            <p className="text-gray-700">
              {t("bivouac.howItWorksDesc4")}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-amber-50 to-amber-100 py-16">
        <div className="container">
          <h2 className="mb-8 text-center text-3xl font-bold">{t("bivouac.ratesTitle")}</h2>
          <p className="mb-12 text-center text-lg text-gray-700">
            {t("bivouac.ratesDesc")}
          </p>

          <div className="mb-16">
            <h3 className="mb-4 text-center text-xl font-bold">{t("bivouac.atLeastTwoPeople")}</h3>
            <div className="mx-auto max-w-2xl overflow-hidden rounded-lg border bg-white shadow-md">
              <div className="grid grid-cols-2 border-b">
                <div className="border-r p-4 font-medium">{t("bivouac.tour")}</div>
                <div className="p-4 font-medium">{t("bivouac.price")}</div>
              </div>
              <div className="grid grid-cols-2 border-b">
                <div className="border-r p-4">{t("bivouac.halfDaySunset")}</div>
                <div className="p-4">35 JOD</div>
              </div>
              <div className="grid grid-cols-2 border-b">
                <div className="border-r p-4">{t("bivouac.fullDaySunset")}</div>
          ...
          <h2 className="mb-8 text-center text-3xl font-bold">
            {t("bivouac.ratesNoOvernightTitle")}
          </h2>
          <div className="mb-8">
            <h3 className="mb-4 text-center text-xl font-bold">{t("bivouac.atLeastTwoPeople")}</h3>
            <div className="mx-auto max-w-2xl overflow-hidden rounded-lg border bg-white shadow-md">
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="mb-8 text-center text-3xl font-bold">{t("bivouac.bookNowTitle")}</h2>
      ...
      <section className="bg-gradient-to-b from-amber-500 to-amber-600 py-16 text-white">
        <div className="container text-center">
          <h2 className="mb-4 text-2xl font-bold">{t("bivouac.expertTeamTitle")}</h2>
          <h3 className="mb-8 text-4xl font-bold">{t("bivouac.expertTeamSubtitle")}</h3>
          <p className="mb-12 text-lg">{t("bivouac.expertTeamDescription")}</p>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="mb-12 text-center text-3xl font-bold">{t("bivouac.includedExcludedTitle")}</h2>
            ...
            <div>
              <ul className="space-y-4">
                <li className="flex items-center">
                  ...
                  <span>{t("bivouac.included1")}</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-4 flex h-8 w-8 items-center justify-center rounded-full bg-green-100">
                    <Check className="h-5 w-5 text-green-600" />
                  </div>
                  <span>{t("bivouac.included2")}</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-4 flex h-8 w-8 items-center justify-center rounded-full bg-green-100">
                    <Check className="h-5 w-5 text-green-600" />
                  </div>
                  <span>{t("bivouac.included3")}</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-4 flex h-8 w-8 items-center justify-center rounded-full bg-green-100">
                    <Check className="h-5 w-5 text-green-600" />
                  </div>
                  <span>{t("bivouac.included4")}</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-4 flex h-8 w-8 items-center justify-center rounded-full bg-green-100">
                    <Check className="h-5 w-5 text-green-600" />
                  </div>
                  <span>{t("bivouac.included5")}</span>
                </li>
              </ul>
            </div>
      ...
      <section className="bg-gradient-to-b from-amber-50 to-amber-100 py-16">
        <div className="container">
          <h2 className="mb-12 text-center text-3xl font-bold">{t("bivouac.youMightLikeTitle")}</h2>
