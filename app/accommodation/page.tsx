    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-black text-white">
        ...
        <div className="container relative z-10 flex items-center justify-center py-24 md:py-32 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight md:text-6xl lg:text-7xl">{t("accommodation.hero.title")}</h1>
        </div>
      </section>
      ...
      <AnimateOnScroll>
        <section className="bg-gradient-to-b from-amber-500 to-amber-600 py-16 text-white">
          <div className="container text-center">
            <h2 className="mb-4 text-2xl font-bold">{t("accommodation.intro.subtitle")}</h2>
            <h3 className="mb-8 text-4xl font-bold">{t("accommodation.intro.title")}</h3>
          ...
          <div className="grid gap-12 md:grid-cols-2">
            ...
            <AnimateOnScroll animation="slide-from-left">
              <div className="rounded-lg bg-white p-6 shadow-lg card-hover">
                ...
                <h3 className="mb-4 text-2xl font-bold">{t("accommodation.tentedCamp.title")}</h3>
                <p className="mb-6 text-gray-700">
                  {t("accommodation.tentedCamp.description")}
                </p>
                <Link href="/accommodation/our-tented-camp">
                  <Button className="bg-amber-500 hover:bg-amber-600 btn-hover-effect">{t("common.learnMore")}</Button>
                </Link>
              </div>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll animation="slide-from-right" delay={200}>
              <div className="rounded-lg bg-white p-6 shadow-lg card-hover">
                ...
                <h3 className="mb-4 text-2xl font-bold">{t("accommodation.bivouac.title")}</h3>
                <p className="mb-6 text-gray-700">
                  {t("accommodation.bivouac.description")}
                </p>
