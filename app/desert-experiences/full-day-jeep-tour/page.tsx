    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-black text-white">
        ...
        <div className="container relative z-10 flex flex-col items-center justify-center py-24 md:py-32 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight md:text-6xl lg:text-7xl">{t("fullDayJeep.title")}</h1>
          <p className="mt-6 max-w-2xl text-center text-xl">
            {t("fullDayJeep.subtitle")}
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="font-medium">{t("fullDayJeep.duration")}</div>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="font-medium">{t("fullDayJeep.guests")}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="md:col-span-2">
              <div className="mb-8">
                ...
                <h3 className="mb-6 text-3xl font-bold">{t("fullDayJeep.title")}</h3>

                <p className="mb-4 text-gray-700">
                  {t("fullDayJeep.description1")}
                </p>
                <p className="mb-4 text-gray-700">
                  {t("fullDayJeep.description2")}
                </p>
                <p className="text-gray-700">
                  {t("fullDayJeep.description3")}
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="overflow-hidden rounded-lg border">
                  <div className="grid grid-cols-2 border-b bg-amber-50">
                    <div className="border-r p-4 font-medium">{t("fullDayJeep.rates.1to3")}</div>
                    <div className="p-4 font-medium">{t("fullDayJeep.rates.1to3.price")}</div>
                  </div>
                  <div className="grid grid-cols-2 border-b">
                    <div className="border-r p-4">{t("fullDayJeep.rates.4to6")}</div>
                    <div className="p-4">{t("fullDayJeep.rates.4to6.price")}</div>
                  </div>
                  <div className="grid grid-cols-2 border-b">
                    <div className="border-r p-4">{t("fullDayJeep.rates.7plus")}</div>
                    <div className="p-4">{t("fullDayJeep.rates.7plus.price")}</div>
                  </div>
                  <div className="grid grid-cols-2 border-b">
                    <div className="border-r p-4">{t("fullDayJeep.rates.children")}</div>
                    <div className="p-4">{t("fullDayJeep.rates.children.price")}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="border-r p-4">{t("fullDayJeep.rates.kids")}</div>
                    <div className="p-4">{t("fullDayJeep.rates.kids.price")}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="mb-4 text-gray-700">
                  {t("fullDayJeep.programIntro")}
                </p>

                <div className="mb-6 space-y-4">
                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.lawrenceSpring.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.lawrenceSpring.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.khazaliCanyon.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.khazaliCanyon.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.redSandDunes.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.redSandDunes.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.umFruthBridge.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.umFruthBridge.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.lunch.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.lunch.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.mushroomRock.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.mushroomRock.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.burdahViewpoint.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.burdahViewpoint.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.abuKhashabaCanyon.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.abuKhashabaCanyon.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("fullDayJeep.sunsetViewing.title")}</h5>
                    <p className="text-gray-700">
                      {t("fullDayJeep.sunsetViewing.desc")}
                    </p>
                  </div>
                </div>

                <p className="text-gray-700">
                  {t("fullDayJeep.conclusion")}
                </p>
              </div>
        ...
        <div className="container">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="overflow-hidden rounded-lg bg-white shadow-md">
              <div className="relative h-48">
                <div className="absolute left-2 top-2 z-10 rounded bg-amber-500 px-2 py-1 text-xs font-medium text-white">
                  {t("fullDayJeep.relatedTours.halfDay.duration")}
                </div>
                <Image src="/images/half-day-jeep.jpg" alt="Half Day Jeep Tour" fill className="object-cover" />
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-xl font-bold">{t("fullDayJeep.relatedTours.halfDay.title")}</h3>
                <p className="mb-4 text-sm text-gray-600">{t("fullDayJeep.relatedTours.halfDay.subtitle")}</p>
                <p className="mb-6 text-sm text-gray-700">
                  {t("fullDayJeep.relatedTours.halfDay.desc")}
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-lg font-bold text-amber-600">
                    {t("common.from")} <span>{t("fullDayJeep.relatedTours.halfDay.price")}</span>
                  </div>
                  <Link href="/desert-experiences/half-day-jeep-tour">
                    <Button size="sm" className="bg-amber-500 hover:bg-amber-600">
                      {t("fullDayJeep.relatedTours.bookNow")}
                    </Button>
                  </Link>
                </div>
              </div>
            ...
            <div className="overflow-hidden rounded-lg bg-white shadow-md">
              <div className="relative h-48">
                <div className="absolute left-2 top-2 z-10 rounded bg-amber-500 px-2 py-1 text-xs font-medium text-white">
                  {t("fullDayJeep.relatedTours.jebelKhash.duration")}
                </div>
                <Image src="/images/jebel-khash.jpg" alt="Jebel Khash Route" fill className="object-cover" />
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-xl font-bold">{t("fullDayJeep.relatedTours.jebelKhash.title")}</h3>
                <p className="mb-4 text-sm text-gray-600">{t("fullDayJeep.relatedTours.jebelKhash.subtitle")}</p>
                <p className="mb-6 text-sm text-gray-700">
                  {t("fullDayJeep.relatedTours.jebelKhash.desc")}
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-lg font-bold text-amber-600">
                    {t("common.from")} <span>{t("fullDayJeep.relatedTours.jebelKhash.price")}</span>
                  </div>
            ...
            <div className="overflow-hidden rounded-lg bg-white shadow-md">
              <div className="relative h-48">
                <div className="absolute left-2 top-2 z-10 rounded bg-amber-500 px-2 py-1 text-xs font-medium text-white">
                  {t("fullDayJeep.relatedTours.allInOne.duration")}
                </div>
                <Image src="/images/all-in-one.jpg" alt="All in One Day" fill className="object-cover" />
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-xl font-bold">{t("fullDayJeep.relatedTours.allInOne.title")}</h3>
                <p className="mb-4 text-sm text-gray-600">{t("fullDayJeep.relatedTours.allInOne.subtitle")}</p>
                <p className="mb-6 text-sm text-gray-700">
                  {t("fullDayJeep.relatedTours.allInOne.desc")}
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-lg font-bold text-amber-600">
                    {t("common.from")} <span>{t("fullDayJeep.relatedTours.allInOne.price")}</span>
                  </div>
