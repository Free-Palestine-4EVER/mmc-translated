    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-black text-white">
        ...
        <div className="container relative z-10 flex flex-col items-center justify-center py-24 md:py-32 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight md:text-6xl lg:text-7xl">{t("halfDayJeep.title")}</h1>
          <p className="mt-6 max-w-2xl text-center text-xl">
            {t("halfDayJeep.subtitle")}
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="font-medium">{t("halfDayJeep.duration")}</div>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="font-medium">{t("halfDayJeep.guests")}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="md:col-span-2">
              <div className="mb-8">
                ...
                <h3 className="mb-6 text-3xl font-bold">{t("halfDayJeep.title")}</h3>

                <p className="mb-4 text-gray-700">
                  {t("halfDayJeep.description1")}
                </p>
                <p className="mb-4 text-gray-700">
                  {t("halfDayJeep.description2")}
                </p>
                <p className="text-gray-700">
                  {t("halfDayJeep.description3")}
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="overflow-hidden rounded-lg border">
                  <div className="grid grid-cols-2 border-b bg-amber-50">
                    <div className="border-r p-4 font-medium">{t("halfDayJeep.rates.1to3")}</div>
                    <div className="p-4 font-medium">{t("halfDayJeep.rates.1to3.price")}</div>
                  </div>
                  <div className="grid grid-cols-2 border-b">
                    <div className="border-r p-4">{t("halfDayJeep.rates.4to6")}</div>
                    <div className="p-4">{t("halfDayJeep.rates.4to6.price")}</div>
                  </div>
                  <div className="grid grid-cols-2 border-b">
                    <div className="border-r p-4">{t("halfDayJeep.rates.7plus")}</div>
                    <div className="p-4">{t("halfDayJeep.rates.7plus.price")}</div>
                  </div>
                  <div className="grid grid-cols-2 border-b">
                    <div className="border-r p-4">{t("halfDayJeep.rates.children")}</div>
                    <div className="p-4">{t("halfDayJeep.rates.children.price")}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="border-r p-4">{t("halfDayJeep.rates.kids")}</div>
                    <div className="p-4">{t("halfDayJeep.rates.kids.price")}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="mb-4 text-gray-700">
                  {t("halfDayJeep.programIntro")}
                </p>

                <div className="mb-6 space-y-4">
                  <div>
                    <h5 className="font-semibold">{t("halfDayJeep.lawrenceSpring.title")}</h5>
                    <p className="text-gray-700">
                      {t("halfDayJeep.lawrenceSpring.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("halfDayJeep.khazaliCanyon.title")}</h5>
                    <p className="text-gray-700">
                      {t("halfDayJeep.khazaliCanyon.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("halfDayJeep.redSandDunes.title")}</h5>
                    <p className="text-gray-700">
                      {t("halfDayJeep.redSandDunes.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("halfDayJeep.littleBridge.title")}</h5>
                    <p className="text-gray-700">
                      {t("halfDayJeep.littleBridge.desc")}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-semibold">{t("halfDayJeep.bedouinTeaBreak.title")}</h5>
                    <p className="text-gray-700">
                      {t("halfDayJeep.bedouinTeaBreak.desc")}
                    </p>
                  </div>
                </div>

                <p className="text-gray-700">
                  {t("halfDayJeep.conclusion")}
                </p>
              </div>
        ...
        <div className="container">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="overflow-hidden rounded-lg bg-white shadow-md">
              <div className="relative h-48">
                <div className="absolute left-2 top-2 z-10 rounded bg-amber-500 px-2 py-1 text-xs font-medium text-white">
                  {t("halfDayJeep.relatedTours.fullDay.duration")}
                </div>
                <Image src="/images/full-day-jeep.jpg" alt="Full Day Jeep Tour" fill className="object-cover" />
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-xl font-bold">{t("halfDayJeep.relatedTours.fullDay.title")}</h3>
                <p className="mb-4 text-sm text-gray-600">{t("halfDayJeep.relatedTours.fullDay.subtitle")}</p>
                <p className="mb-6 text-sm text-gray-700">
                  {t("halfDayJeep.relatedTours.fullDay.desc")}
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-lg font-bold text-amber-600">
                    {t("common.from")} <span>{t("halfDayJeep.relatedTours.fullDay.price")}</span>
                  </div>
                  <Link href="/desert-experiences/full-day-jeep-tour">
                    <Button size="sm" className="bg-amber-500 hover:bg-amber-600">
                      {t("halfDayJeep.relatedTours.bookNow")}
                    </Button>
                  </Link>
                </div>
              </div>
            ...
            <div className="overflow-hidden rounded-lg bg-white shadow-md">
              <div className="relative h-48">
                <div className="absolute left-2 top-2 z-10 rounded bg-amber-500 px-2 py-1 text-xs font-medium text-white">
                  {t("halfDayJeep.relatedTours.camelRide.duration")}
                </div>
                <Image src="/images/camel-ride.jpg" alt="Camel Ride" fill className="object-cover" />
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-xl font-bold">{t("halfDayJeep.relatedTours.camelRide.title")}</h3>
                <p className="mb-4 text-sm text-gray-600">{t("halfDayJeep.relatedTours.camelRide.subtitle")}</p>
                <p className="mb-6 text-sm text-gray-700">
                  {t("halfDayJeep.relatedTours.camelRide.desc")}
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-lg font-bold text-amber-600">
                    {t("common.from")} <span>{t("halfDayJeep.relatedTours.camelRide.price")}</span>
                  </div>
            ...
            <div className="overflow-hidden rounded-lg bg-white shadow-md">
              <div className="relative h-48">
                <div className="absolute left-2 top-2 z-10 rounded bg-amber-500 px-2 py-1 text-xs font-medium text-white">
                  {t("halfDayJeep.relatedTours.allInOne.duration")}
                </div>
                <Image src="/images/all-in-one.jpg" alt="All in One Day" fill className="object-cover" />
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-xl font-bold">{t("halfDayJeep.relatedTours.allInOne.title")}</h3>
                <p className="mb-4 text-sm text-gray-600">{t("halfDayJeep.relatedTours.allInOne.subtitle")}</p>
                <p className="mb-6 text-sm text-gray-700">
                  {t("halfDayJeep.relatedTours.allInOne.desc")}
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-lg font-bold text-amber-600">
                    {t("common.from")} <span>{t("halfDayJeep.relatedTours.allInOne.price")}</span>
                  </div>
